...
cat /vagrant/configs/vhosts/local.omicron.net.pl.conf > /etc/apache2/sites-available/local.omicron.net.pl.conf
#cat /vagrant/configs/vhosts/local.mercudo.wardx.net.conf > /etc/apache2/sites-available/local.mercudo.wardx.net.conf

echo -e "\n=> Enabling vhosts\n"
a2ensite local.wardx.net.conf >> /vagrant/log/vhosts.log 2>&1
a2ensite local.dopierala.net.pl.conf >> /vagrant/log/vhosts.log 2>&1
a2ensite local.omicron.net.pl.conf >> /vagrant/log/vhosts.log 2>&1
#a2ensite local.mercudo.wardx.net.conf >> /vagrant/log/vhosts.log 2>&1
